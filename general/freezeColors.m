...
% error(nargchk(1,1,nargin,'struct')) % commented Moore
error(nargchk(1,1,nargin)) % for matlab sucky version
hout = [];
...
nargs = length(args);
%error(nargchk(0,3,nargs,'struct')) % commented Moore
error(nargchk(0,3,nargs)) % changed for matlab sucky version
